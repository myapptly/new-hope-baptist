    ...
    <main className="min-h-screen bg-[#eeeaf3] text-[#211b29]">
      <div className="mx-auto min-h-screen max-w-md overflow-hidden bg-[#fbf9fd] pb-24 shadow-2xl">
        ...
        <section className="mx-4 mt-4 overflow-hidden rounded-[24px] border border-[#d8b84e] bg-gradient-to-br from-[#fffaf0] to-[#f5ecce] shadow-sm">
          <div className="p-5 text-center"><p className="text-xs font-bold uppercase tracking-[0.22em] text-[#8b6511]">Mentoring &amp; Evangelism</p><div className="mx-auto mt-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#0b285c] text-2xl text-white shadow">🏀</div><h2 className="mt-3 font-serif text-2xl font-bold text-[#0b285c]">New Hope / Victory Path</h2><p className="mt-2 text-sm leading-6 text-[#62583f]">A basketball program for young women centered on faith, mentoring, character and opportunity.</p><a href="/victory-path" className="mt-4 block rounded-[16px] bg-[#0b285c] px-4 py-3 text-sm font-bold text-white">Visit Victory Path</a></div>
        </section>
